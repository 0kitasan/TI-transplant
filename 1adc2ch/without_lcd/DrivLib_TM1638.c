...
SPI_Regs *LED_SPI_PTR = NULL;
GPIO_Regs *LCD_GPIO_DC_PORT = NULL;
uint32_t LCD_GPIO_DC_PIN = 0;

void TM1638_init(SPI_Regs *USR_TM1638_SPI_PTR,
                 GPIO_Regs *USR_TM1638_GPIO_CS_PORT,
                 uint32_t USR_TM1638_GPIO_CS_PIN) {
  LED_SPI_PTR = USR_TM1638_SPI_PTR;
  LCD_GPIO_DC_PORT = USR_TM1638_GPIO_CS_PORT;
  LCD_GPIO_DC_PIN = USR_TM1638_GPIO_CS_PIN;
}
